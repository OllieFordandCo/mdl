...
export default css`
  ...
  .sl-theme-dark {
    ...
    --sl-color-lime-50: hsl(67 100% 70%);
    --sl-color-lime-100: hsl(67 100% 60%);
    --sl-color-lime-200: hsl(69 100% 53%);
    --sl-color-lime-300: hsl(69 100% 47%);
    --sl-color-lime-400: hsl(73 100% 45%);
    --sl-color-lime-500: hsl(78 100% 50%);
    --sl-color-lime-600: hsl(78 100% 42%);
    --sl-color-lime-700: hsl(84 100% 34%);
    --sl-color-lime-800: hsl(89 100% 25%);
    --sl-color-lime-900: hsl(89 100% 20%);
    --sl-color-lime-950: hsl(89 100% 10%);
